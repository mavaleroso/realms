...
<html>
<!-- Google font-->
<link rel="icon" href="<?php echo BASE_URL ?>/assets/cuba/assets/images/favicon.png" type="image/x-icon">
<link rel="shortcut icon" href="<?php echo BASE_URL ?>/assets/cuba/assets/images/favicon.png" type="image/x-icon">
...
<link rel="stylesheet" type="text/css" href="<?php echo BASE_URL ?>/assets/plugins/css/sweetalert2.min.css">
